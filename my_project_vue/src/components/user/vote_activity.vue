  ...
  export default{
    ...
    methods:{
      getVotedActivities(){
        ...
        console.log(id)
        this.$axios({
          url: `/vote/getVotedActivities/${id}/${this.pagination.current}/${this.pagination.size}`
        }).then(res => {
      ...
      getActivityDetail(id){
          this.$router.push({path:"/user/activity_detail", query:{id: id}})
          console.log(id)
      },
